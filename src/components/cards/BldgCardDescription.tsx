...
export default function CardDescription({
  ...
  return (
    <div className="margin-auto z-10 row-span-1 mx-4 my-2 flex h-auto items-center justify-center rounded-sm border-slate-300 bg-slate-300 p-2 text-center text-sm text-black shadow-md">
