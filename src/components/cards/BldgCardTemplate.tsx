...
export default function BldgCardTemplate({ children }: BldgCardTemplateProps) {
  return (
    ...
    <div className="grid w-52 auto-rows-auto gap-1 rounded-md border-4 border-blue-900 bg-white/5 text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-gray-500/50">
      {children}
    </div>
  );
}
