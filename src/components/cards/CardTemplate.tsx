...
export default function CardTemplate({ color, children }: CardTemplateProps) {
  ...
  return (
    ...
    <div
      className={`group m-[2px] grid w-52 auto-rows-auto justify-around gap-1 rounded-lg border border-white/10 bg-zinc-800 bg-cover bg-center text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-gray-500/50`}
    >
      {children}
    </div>
  );
