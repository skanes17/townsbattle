  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        beastRider: "url('/src/assets/images/beastRider-01.jpg')",
        beastRiderSm: "url('/src/assets/images/beastRider-01-128px.jpg')",
        beastRiderMd: "url('/src/assets/images/beastRider-01-256px.jpg')",
        beastRiderLg: "url('/src/assets/images/beastRider-01-512px.jpg')",
